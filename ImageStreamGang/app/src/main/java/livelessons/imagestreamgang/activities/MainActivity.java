...
public class MainActivity 
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Set animations appropriately
        default_fab_show = AnimationUtils.loadAnimation(getApplication(), R.anim.default_fab_show);
        default_fab_hide = AnimationUtils.loadAnimation(getApplication(), R.anim.default_fab_hide);
        clear_fab_show = AnimationUtils.loadAnimation(getApplication(), R.anim.clear_fab_show);
        clear_fab_hide = AnimationUtils.loadAnimation(getApplication(), R.anim.clear_fab_hide);
        default_fab_local_show = AnimationUtils.loadAnimation(getApplication(), R.anim.default_fab_local_show);
        default_fab_local_hide = AnimationUtils.loadAnimation(getApplication(), R.anim.default_fab_local_hide);
     ...
     */
    public void runWithDefaultUrls(View view) {
        runURLs(view, Options.InputSource.DEFAULT);
    }

    /**
     * Run the ImageStreamGang using default images stored locally
     */
    public void runWithDefaultLocal(View view) {
        runURLs(view, Options.InputSource.DEFAULT_LOCAL);
    }
    ...
    /**
     * Displays floating action button menu
     */
    public void showFabMenu() {
        ...
        mDefaultFab.setLayoutParams(layoutParamsDefaultFab);
        mDefaultFab.startAnimation(default_fab_show);
        mDefaultFab.setClickable(true);

        // Set up and show the default (local) menu mini floating action button
        FrameLayout.LayoutParams layoutParamsDefaultLocalFab = (FrameLayout.LayoutParams) mDefaultLocalFab.getLayoutParams();
        layoutParamsDefaultLocalFab.rightMargin += (int) (mDefaultLocalFab.getWidth() * 1.5);
        ...
        mClearFab.setClickable(true);
    }

    /**
     * Hides floating action button menu
     */
    public void hideFabMenu() {
        ...
        mDefaultFab.setLayoutParams(layoutParams);
        mDefaultFab.startAnimation(default_fab_hide);
        mDefaultFab.setClickable(false);

        // Hide the default (local) menu mini floating action button
        FrameLayout.LayoutParams layoutParamsDefaultLocalFab = (FrameLayout.LayoutParams) mDefaultLocalFab.getLayoutParams();
        layoutParamsDefaultLocalFab.rightMargin -= (int) (mDefaultLocalFab.getWidth() * 1.5);
        layoutParamsDefaultLocalFab.bottomMargin -= (int) (mDefaultLocalFab.getHeight() * 1.5);
        mDefaultLocalFab.setLayoutParams(layoutParamsDefaultLocalFab);
